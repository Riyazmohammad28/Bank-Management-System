...
public class Signupthree extends JFrame implements ActionListener {
    ...
    Signupthree(String formno){
        ...
        type.setFont(new Font("Raleway",Font.BOLD,38));
        ...
        JLabel number=new JLabel("XXXX-XXXX-XXXX-8786");
        number.setFont(new Font("Raleway",Font.BOLD,38));
        number.setBounds(330,300,300,30);
        add(number);
        
        JLabel n=new JLabel("Your 16 Digit Card Number");
        n.setFont(new Font("Raleway",Font.BOLD,16));
        n.setBounds(100,330,300,20);
        add(n);
        ...
        pnumber.setFont(new Font("Raleway",Font.BOLD,38));
        pnumber.setBounds(330,370,300,30);
        add(pnumber);
        JLabel nn=new JLabel("Your 4 Digit Pin Number");
        nn.setFont(new Font("Raleway",Font.BOLD,16));
        nn.setBounds(100,400,300,20);
        add(nn);
        
        JLabel ser=new JLabel("Service Required");
        ser.setFont(new Font("Raleway",Font.BOLD,30));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(c1.isSelected()){
            ...
            fa=fa+"Internet banking";
        }else if(c3.isSelected()){
            fa=fa+"Mobile Banking";
        }else if(c4.isSelected()){
            fa=fa+"Email and Sma alerts";
            ...
            try{
                ...
                Conn c=new Conn();
             String query="insert into signupthree values('"+formno+"','"+accounttype+"','"+cardno+"','"+pinno+"','"+fa+"')";
